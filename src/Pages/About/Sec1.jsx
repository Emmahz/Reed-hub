import about1 from "../../assets/images/about-1 copy.png"


const Sec1 =() => {
    return (
        <>
        <div className="font-bold text-white text-2xl py-11">About Us</div>
    ...
    <img className='lg:w-[40%] w-[90%] lg:max-w-[40%]' src={about1} />
</div>
        </>
    )
}
