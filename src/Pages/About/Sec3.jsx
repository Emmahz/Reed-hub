...
<div className='container  flex lg:flex-row flex-col justify-center w-screen gap-[4.4rem] items-center mt-[3rem]'>
    ...
    <p className='text-[#35caaa83] font-extrabold text-center text-xl mr-[26rem]'>Our Process</p>
        <p className='text-[#E3FFCC] lg:text-left text-center lg:leading-[4rem] leading-10'>
